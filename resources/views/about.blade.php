    ...
    class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-black mx-6 lg:mx-0" style="opacity: 0.9;">
        ...
        <div class="p-4 md:p-12 text-center lg:text-left">
            ...
            <p class="pt-4 text-base font-bold flex items-center justify-center lg:justify-start text-white">
                <svg class="h-4 fill-current text-white-700 pr-4" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20">
                    <path
                        d="M9 12H1v6a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-6h-8v2H9v-2zm0-1H0V5c0-1.1.9-2 2-2h4V2a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v1h4a2 2 0 0 1 2 2v6h-9V9H9v2zm3-8V2H8v1h4z" />
                </svg> Movie Blogging and Reviews
            </p>
            <p class="pt-4 text-base font-bold flex items-center justify-center lg:justify-start text-white">
                <svg class="h-4 fill-current text-white-700 pr-4" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20">
                ...
                </svg>   Based in the Heart of Cinema City
            </p>
            <p class="pt-8 text-base text-white">    At Cinephile Chronicles, we delve beyond the surface of the screen to share in-depth movie recommendations, engaging blog posts, and foster a vibrant community of film enthusiasts. Our goal is not just to recommend films but to spark discussions that bring us closer to the art of cinema. This blog was born from a passion for storytelling and the transformative power of movies. We believe in the magic that happens in the dark of the cinema or the comfort of our living rooms. Here, every frame, scene, and dialogue is an opportunity to explore new worlds, understand different perspectives, and connect with fellow cinephiles. Join us as we celebrate cinema in all its forms, from the underappreciated gems to the biggest blockbusters. Dive into a world where cinema comes to life, and discover why each story told through the lens is a window to something greater than ourselves.
            </p>

            <div class="pt-12 pb-8">
                <a href="/contact_us" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-full inline-block">
                    Get In Touch
                </a>
            </div>
